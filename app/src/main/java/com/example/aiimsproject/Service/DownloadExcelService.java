...
public class DownloadExcelService extends IntentService implements Callback<ResponseBody> {

    private static final String FileName = "EmployeeExcel";

    public DownloadExcelService() {
    ...
    private void initDownload(){
        ...
        Call<ResponseBody> listCall = apiInterface.downloadExcel();
    ...
    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
        ...
        Log.e("Excel", String.valueOf(statusCode));
        if (statusCode == 200) {
            try {
    ...
    private void downloadFile(ResponseBody body) throws IOException {
        ...
        outputFile = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), FileName+(ValidationUtil.longToDate(System.currentTimeMillis()))+".xlsx");
    ...
    private void sendIntent(Download download){
        ...
        LocalBroadcastManager.getInstance(DownloadExcelService.this).sendBroadcast(intent);
    }
